...
class Application:
    ...
    def setupAlphaButtonAndLabel(self, win):
        self.alpha_minus = tkinter.Button(
            win, text="-", command=(lambda: self.incrementAlpha(self.dec))
        )
    ...
    def setupSpeedButtonAndLabel(self, win):
        ...
        self.speed_plus = tkinter.Button(
            win, text="+", command=(lambda: self.incrementSpeed(2))
        )
