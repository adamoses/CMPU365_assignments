...
Pac-Man agents (in searchAgents.py).
"""
...
def depthFirstSearch(problem):
    ...
    while(not frontier.isEmpty()):
        ...
        if not node[0] in visited:
            ...
            succs = problem.getSuccessors(node[0])

            for succ in succs:
                newPath = node[1].copy()
                newPath.append(succ[1])
                newNode = [succ[0], newPath, node[2]+1]
    ...
    while(not frontier.isEmpty()):
        ...
        if not node[0] in visited:
            ...
            for succ in succs:
                ...
                newNode = [succ[0], newPath, newCost]
    ...
    while(not frontier.isEmpty()):
        ...
        if not node[0] in visited:
            ...
            for succ in succs:
                newPath = node[1].copy()
                newPath.append(succ[1])
                newCost = problem.getCostOfActions(newPath)+heuristic(succ[0], problem)
                newNode = [succ[0], newPath, newCost]
                frontier.push(newNode, newNode[2])
